...
def start_pb():
    while True:
        ...
        match choice:
            ...
            case 5:
                lookup_contact = view.search_name(5)
                view.show_contacts(model.search_contact(lookup_contact), txt.contact_not_found)
            case 6:
                lookup_contact = view.search_name(6)
                # model.edit_contact(lookup_contact)
                view.ask_change_parameter()

            case 7:
                lookup_contact = view.search_name(7)
